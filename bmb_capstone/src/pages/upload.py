  ...
  def callbacks(self):
    ...
    def update_output(clicks, tag, hasMask, val, imageJ):
      ...
      if clicks > 0 and \
        ...
        examples = html.Div([
          html.H3("Correct Segmented Masks",
                  className=Upload.Formatting()),

          dbc.Row([
            dbc.Col([
                Upload.PI2(Upload.ReadImage("p1.png", 'pages/assets'))
            ]),
            dbc.Col([
                Upload.PI2(Upload.ReadImage("p2.png", 'pages/assets'))
            ]), 
            dbc.Col([
                Upload.PI2(Upload.ReadImage("p3.png", 'pages/assets'))
            ]), 
          ], align='justify'),
          
          html.H3("Incorrect Segmented Masks",
                  className=Upload.Formatting()),

          dbc.Row([
            dbc.Col([
                Upload.PI2(Upload.ReadImage("b1.png", 'pages/assets'))
            ]),
            dbc.Col([
                Upload.PI2(Upload.ReadImage("b2.png", 'pages/assets'))
            ]),
          ], align='justify'),
        ])
