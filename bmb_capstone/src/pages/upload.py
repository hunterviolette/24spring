    ...
    def update_output(clicks, tag, hasMask, val, imageJ):
      ...
      if clicks > 0 and \
        ...
        for key in fileDict.keys():
          ...
          if hasMask:
            mdiv.extend([
                ...
                dbc.Row([
                    dbc.Col([
                        Upload.PI2(ro["img"], wh=650, zoom=True)
                    ], width=6),
                    dbc.Col([
                        Upload.TI2(ro["img"], ro["mask"], wh=650, zoom=True)
                    ], width=6), 
                ], align='justify'),
            ])
          else: mdiv.extend([html.H5(key), Upload.PI2(ro["img"], wh=650, zoom=True)])
        ...
        examples = html.Div([
          ...
          dbc.Row([
            dbc.Col([
                Upload.PI2(Upload.ReadImage("nonSeg.png", 'pages/assets'), 500, False),
                dcc.Markdown('''
            ...
            dbc.Col([
                Upload.PI2(Upload.ReadImage("tif_png.png", 'pages/assets'), 700, False),
                dcc.Markdown('''
          ...
          dbc.Row([
              Upload.PI2(Upload.ReadImage("vsi.png", 'pages/assets'), 1000, False),
              dcc.Markdown('''
                  <ul style="list-style-position: inside; text-align: center;">
                      <li>Accepts raw microspy data with x.vsi and _x_/stack1/frame_t_0.ets file format</li>
          ...
          dbc.Row([
            dbc.Col([
                Upload.PI2(Upload.ReadImage("p1.png", 'pages/assets'), 700, False)
            ]),
            dbc.Col([
                Upload.PI2(Upload.ReadImage("p2.png", 'pages/assets'), 700, False)
            ]), 
            dbc.Col([
                Upload.PI2(Upload.ReadImage("p3.png", 'pages/assets'), 700, False)
            ]), 
          ], align='justify'),
          ...
          dbc.Row([
            dbc.Col([
                Upload.PI2(Upload.ReadImage("b1.png", 'pages/assets'), 700, False)
            ]),
            dbc.Col([
                Upload.PI2(Upload.ReadImage("b2.png", 'pages/assets'), 700, False)
            ]),
          ], align='justify'),
        ])
